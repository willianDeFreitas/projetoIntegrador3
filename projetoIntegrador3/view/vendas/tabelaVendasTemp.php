...
<div class="table-responsive-xl">
    <table class="table table-responsive-sm table-hover table-striped table-bordered" style="text-align: center; white-space: nowrap;">
        ...
        <?php
            ...
            if(isset($_SESSION['tabelaVendaTemp'])):
                $i=0;
                foreach (@$_SESSION['tabelaVendaTemp'] as $key) {
    ...
    <span class="btn btn-success" onclick="criarVenda()">
        <i class="fas fa-check"></i>
        Confirmar
    </span>
    <span class="btn btn-danger" onclick="limparVendas()">
        <span class="fas fa-trash-alt"></span>
        Limpar Venda
    </span>
</div>
